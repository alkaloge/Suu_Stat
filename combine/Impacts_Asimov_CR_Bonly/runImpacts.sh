...
combineTool.py -M Impacts -d CR_${year}_3000.root -m 3000 --doInitialFit -n CR_${year}_nodata_nosignal --rMin -20.0 --rMax 20.0 --setParameters r=0${maskedChannels} --freezeParameters r --expectSignal 0 --cminDefaultMinimizerStrategy 0 --cminPreScan --cminPreFit 1 --robustFit 1 --cminDefaultMinimizerTolerance 0.1

combineTool.py -M Impacts -d CR_${year}_3000.root -m 3000 --doFit -n CR_${year}_nodata_nosignal --rMin -20.0 --rMax 20.0 --freezeParameters r --expectSignal 0 --cminDefaultMinimizerStrategy 1 --cminPreScan --cminPreFit 1 --setParameters r=0${maskedChannels} -t -1 --job-mode condor --sub-opts='+JobFlavour="microcentury"' --task-name Impact_CR_${year}_nodata_nosignal  --robustFit 1 --cminDefaultMinimizerTolerance 0.1
